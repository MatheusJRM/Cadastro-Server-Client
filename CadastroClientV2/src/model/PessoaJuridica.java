...
@NamedQueries({
    ...
    @NamedQuery(name = "PessoaJuridica.findById", query = "SELECT p FROM PessoaJuridica p WHERE p.id = :pessoaId"), // Alterado para p.id
...
public class PessoaJuridica extends Pessoa implements Serializable {
    ...
    public PessoaJuridica(Integer pessoaId, String nome, String telefone, TiposPessoa idTipoPessoa, String cnpj) {
        super(pessoaId, nome, telefone, idTipoPessoa); // Chama o construtor da classe base
        this.cnpj = cnpj;
    }
